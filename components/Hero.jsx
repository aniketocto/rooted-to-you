      ...
      >
        <SwiperSlide>
          <div className=" w-full h-full hero-bg-1 flex flex-col items-start justify-end md:justify-center px-0 sm:px-10">
            <div className="flex flex-col item-center md:items-start justify-center w-full md:w-[50%] gap-5 mt-[10%] px-8 mobile-gap-small">
        ...
        <SwiperSlide>
          <div className=" w-full h-full hero-bg-2 flex flex-col items-start justify-end md:justify-center px-0 sm:px-10">
            <div className="flex flex-col item-center md:items-start justify-center w-full md:w-[60%] gap-5 mt-[10%] px-8 mobile-gap-small">
